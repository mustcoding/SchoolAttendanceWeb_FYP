...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Activity Occurrences</h1>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <div class="col-lg-12">
          ...
          <div class="card">
              <div class="card-body">
                <h5 class="card-title">Activity Occurrence Details</h5>
                ...
                <div class="col-12">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="editRFID(
                      event,
                      document.getElementById('occurrenceName').value,
  ...
  <script>
    ...
    function editRFID(event, name, description) {
        event.preventDefault();

        // Get the staff ID from the URL
        const queryString = window.location.search;
        const urlParams = new URLSearchParams(queryString);
        const occurrence_id = urlParams.get('id');
        ...
        fetch('/OccurrenceType/update/' + occurrence_id, {
            method: 'PUT',
            headers: {
    ...
    <script>
        ...
        function fetchDetails(occurrence_id)
        {
            const data = 
            {
                id: occurrence_id
            ...
            fetch('/OccurrenceType/'+occurrence_id,
            {
        ...
        function updateDetails(data)
        {
            ...
            const name = document.getElementById('occurrenceName');
            const description = document.getElementById('description');
         

            // Set the values of the input fields
            name.value = data.occurrence.name;
            description.value = data.occurrence.description;
        ...
        document.addEventListener('DOMContentLoaded', function () 
        {
            ...
            console.log('Tourism Service ID:', occurrence_id);
            // Fetch data when the page loads
            fetchDetails(occurrence_id);
        });
