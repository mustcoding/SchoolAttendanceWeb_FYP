...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Activity Occurrences Management</h1>
    </div><!-- End Page Title -->

    <div class="alert alert-success alert-dismissible fade show" role="alert1" style="display: none;">
      Here is the Activity Occurrences you were searching for.
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>

    <div class="alert alert-danger alert-dismissible fade show" role="alert2" style="display: none;">
      Houston... we can't find the Activity Occurrences you search.
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>

    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Search Activity Occurrences</h5>
    
            <form class="row g-3 align-items-center">
              <div class="col-md-6">
                  <div class="input-group">
                      <input type="text" class="form-control me-2" id="services" placeholder="Enter Activity Occurrences">
        ...
        const row = `<tr>
                      ...
                      <td>
                        <div class="button-column">
                          <button type="button" class="btn btn-primary" onclick="editActivityOccurrence(${item.id})">Edit</button>
                          <button type="button" class="btn btn-danger" onclick="deleteActivityOccurrence(${item.id})">Delete </button>
                        </div>
                      </td>
                    </tr>`;
  ...
  function editActivityOccurrence(occurence_id){
     // Get the tourismServiceId from the URL
    
     window.open(`editActivityOccurrence?id=${occurence_id}`,'_self');
  }

  function deleteActivityOccurrence(occurrence_id)
  {

    if (confirm('Are you sure you want to delete this activity occurrences?')) {
      var is_Delete=1;
      ...
      fetch('/OccurrenceType/delete/'+occurrence_id, {
        ...
        .then(data => {
              ...
              console.log("Activity Occurrences Successfully deleted ", data);
              window.location.href = "/activityOccurrenceManagement";
