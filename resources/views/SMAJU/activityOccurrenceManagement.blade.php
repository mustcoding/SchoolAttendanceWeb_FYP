...
<li class="nav-item">
  ...
  <script>
    ...
    function fetchData() {
      fetch('http://127.0.0.1:8000/OccurrenceType/all-data')
  ...
  function deleteActivityOccurrence(occurrence_id)
  {
    ...
    fetch('http://127.0.0.1:8000/OccurrenceType/delete/'+occurrence_id, {
      ...
      .then(data => {
            ...
            window.location.href = "http://127.0.0.1:8000/activityOccurrenceManagement";
