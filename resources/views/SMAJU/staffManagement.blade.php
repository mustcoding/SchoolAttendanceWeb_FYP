...
<body>
            ...
            <form class="row g-3 align-items-center">
              <div class="col-md-6">
                  <div class="input-group">
                      <input type="text" class="form-control me-2" id="services" placeholder="Enter Staff name @ Position">
        ...
        const row = `<tr>
                      ...
                      <td>
                        <div class="button-column">
                          <button type="button" class="btn btn-primary" onclick="editStaff(${item.id})">Edit</button>
                          <button type="button" class="btn btn-danger" onclick="deleteStaff(${item.id})">Delete </button>
                        </div>
                      </td>
                    </tr>`;
  ...
  function editStaff(staff_id){
     ...
     window.open(`editStaff?id=${staff_id}`,'_self');
  }
