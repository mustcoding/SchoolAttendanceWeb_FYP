...
<li class="nav-item">
  ...
  <script>
    ...
    function saveSchoolSession()
    {
        ...
        fetch('/classroom/get-classroom/'+classroomId, 
        {
            ...
            .then(response => 
            {
                if (response.ok)
                {
                    ...
                    setTimeout(function() 
                    {
                        window.location.href = '/add-classroom-by-session';
                    }, 2000);
                }
            })
            .then(data => {
              ...
              window.location.href = '/add-student-in-classroom';
