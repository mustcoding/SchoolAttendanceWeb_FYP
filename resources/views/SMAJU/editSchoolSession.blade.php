...
<body>
          ...
          <div class="card">
              <div class="card-body">
                ...
                <div class="col-6">
                    ...
                    <div class="col-6">
                        <label for="className" class="form-label">Year</label>
                    ...
                    <button type="submit" class="btn btn-primary" onclick="editSchoolSession(
                      event,
  ...
  <script>
    ...
    function editSchoolSession(event, start_date, end_date, year) {
        event.preventDefault();

        // Get the staff ID from the URL
        const queryString = window.location.search;
        const urlParams = new URLSearchParams(queryString);
        const ss_id = urlParams.get('id');
        ...
        fetch('http://127.0.0.1:8000/SchoolSession/update/' + ss_id, {
            method: 'PUT',
            headers: {
...
<!--to automatically update the year field referring to the year of start date-->
<script>
    ...
    startDateInput.addEventListener('change', function () {
        ...
        // Update the "Year" input field with the selected year
    ...
    <script>
        ...
        function fetchDetails(ss_id)
        {
            ...
            fetch('http://127.0.0.1:8000/SchoolSession/'+ss_id,
            {
        ...
        function updateDetails(data)
        {
            ...
            start_date.value = data.SchoolSession.start_date;
            end_date.value = data.SchoolSession.end_date;
            year.value = data.SchoolSession.year;
        ...
        document.addEventListener('DOMContentLoaded', function () 
        {
            ...
            console.log('Tourism Service ID:', ss_id);
