...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert2" style="display: none;">
      Houston....RFID Number Already Exist.
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>

    <div class="pagetitle">
      <h1>Add New RFID Number</h1>
    </div><!-- End Page Title -->
              ...
              <div class="card-body">
                ...
                <form id="RFIDForm" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-primary" onclick="saveRFID(value)">Save</button>
  ...
  <script>
    ...
    function saveRFID()
    {
        var classroomForm = document.getElementById('RFIDForm');
        ...
        if (classroomForm.checkValidity()) {
            ...
            var type = document.getElementById('rfidType').value;
           var is_Delete=0;
            const data = {
                number: rfidNumber,
                type: type,
        ...
        fetch('http://127.0.0.1:8000/rfid/add', 
        {
