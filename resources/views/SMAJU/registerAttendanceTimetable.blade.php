...
<body>
  ...
  <script>
    ...
    function saveSchoolSession()
    {
        ...
        var occurrence_id = document.getElementById('occurrenceId').value;
        ...
        var is_Delete=0; 
            ...
            fetch('http://127.0.0.1:8000/AttendanceTimetable/add', 
            {
            ...
            .then(response => 
            {
                if (response.ok)
                {
                    ...
                    setTimeout(function() 
                    {
                        window.location.href = 'http://127.0.0.1:8000/add-attendance-timetable';
                    }, 2000);
                }
            })
            .then(data => {
...
<script>
    function fetchOccurrences(){
        fetch('http://127.0.0.1:8000/AttendanceTimetable/all-data')
            .then(response => response.json())
            .then(data => {
