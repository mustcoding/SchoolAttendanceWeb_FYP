...
<body>
          ...
          <div class="card">
              <div class="card-body">
                ...
                <form id="studentForm" class="row g-3 needs-validation" validate>
                    <div class="col-12">
                        <label for="startDate" class="form-label">RFID Tag Number<span style="color: red;"> *</label>
                        <input type="type" class="form-control" id="rfidNumber" required>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="form" class="form-label">Type of RFID</label>
                                <select class="form-select" id="rfidType" required>
                    ...
                    <button type="submit" class="btn btn-primary" onclick="editRFID(
                      event,
                      document.getElementById('rfidNumber').value,
                      document.getElementById('rfidType').value,
                      )">Save</button>
  ...
  <script>
    ...
    function editRFID(event, rfid_number, type) {
        event.preventDefault();

        // Get the staff ID from the URL
        const queryString = window.location.search;
        const urlParams = new URLSearchParams(queryString);
        const rfid_id = urlParams.get('id');

        // Validation for empty fields
        if (rfid_number.trim() === '' || type.trim() === '') {
        ...
        fetch('http://127.0.0.1:8000/rfid/update/' + rfid_id, {
            method: 'PUT',
            headers: {
    ...
    <script>
        ...
        function fetchDetails(rfid_id)
        {
            ...
            fetch('http://127.0.0.1:8000/rfid/'+rfid_id,
            {
        ...
        function updateDetails(data)
        {
            ...
            rfid_number.value = data.rfid.number;
        ...
        document.addEventListener('DOMContentLoaded', function () 
        {
            ...
            console.log('Tourism Service ID:', rfid_id);
            // Fetch data when the page loads
            fetchDetails(rfid_id);
        });
